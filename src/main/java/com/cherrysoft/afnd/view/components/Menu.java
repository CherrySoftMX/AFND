...
import com.cherrysoft.afnd.view.components.afnd.states.FinalState;
import com.cherrysoft.afnd.view.components.afnd.states.InitialFinalState;
import com.cherrysoft.afnd.view.components.afnd.states.InitialState;
import com.cherrysoft.afnd.view.components.afnd.states.NormalState;
...
public class Menu implements Drawable {
  ...
  public static com.cherrysoft.afnd.view.components.AbstractButton ADD_INITIAL_STATE_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("Initial state")
      .setID(InitialState.INITIAL_STATE_ID)
      .build();

  public static com.cherrysoft.afnd.view.components.AbstractButton ADD_NORMAL_STATE_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("Normal state")
      .setID(NormalState.NORMAL_STATE_ID)
      .build();

  public static com.cherrysoft.afnd.view.components.AbstractButton ADD_FINAL_STATE_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("Final state")
      .setID(FinalState.FINAL_STATE_ID)
      .build();

  public static com.cherrysoft.afnd.view.components.AbstractButton ADD_INITIAL_FINAL_STATE_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("Initial-final")
      .addLine("state")
      .setID(InitialFinalState.INITIAL_FINAL_STATE_ID)
      .build();

  public static com.cherrysoft.afnd.view.components.AbstractButton MOVE_STATE_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("Move state")
      .setID(MOVE_STATE_ID)
      .build();

  public static com.cherrysoft.afnd.view.components.AbstractButton DELETE_STATE_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("Delete state")
      .setID(DELETE_STATE_ID)
      .build();

  public static com.cherrysoft.afnd.view.components.AbstractButton ADD_NORMAL_CONNECTION_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("Normal")
      .addLine("connection")
      .setID(NORMAL_CONNECTION_ID)
      .build();

  public static com.cherrysoft.afnd.view.components.AbstractButton ADD_LOOP_CONNECTION_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("Loop")
      .addLine("connection")
      .setID(LOOP_CONNECTION_ID)
      .build();

  public static com.cherrysoft.afnd.view.components.AbstractButton DELETE_CONNECTION_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("Delete")
      .addLine("connection")
      .setID(DELETE_CONNECTION_ID)
      .build();

  public static com.cherrysoft.afnd.view.components.AbstractButton VERIFY_AUTOMATA_BUTTON = new com.cherrysoft.afnd.view.components.AbstractButton.ButtonBuilder()
      .addLine("VERIFY")
  ...
  public static com.cherrysoft.afnd.view.components.AbstractButton STEP_VERIFICATION_BUTTON = new AbstractButton.ButtonBuilder()
