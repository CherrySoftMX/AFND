...
public class Menu implements Drawable {
  ...
  public Menu(VisualAFND visualAFND) {
    this.visualAFND = visualAFND;
    initComponents();
  }

  private void initComponents() {
    visualAFND.addSwingComponent(TEXT_FIELD);
  }
  ...
  private void drawButtons(Graphics2D g) {
    BUTTON_ADD_ESTADO_INICIAL.setPosition(visualAFND.getWidth() - 260, 80);
    BUTTON_ADD_ESTADO_NORMAL.setPosition(visualAFND.getWidth() - 140, 80);
    BUTTON_ADD_ESTADO_FINAL.setPosition(visualAFND.getWidth() - 260, 140);
    BUTTON_ADD_ESTADO_INICIAL_FINAL.setPosition(visualAFND.getWidth() - 140, 140);
    BUTTON_MOVER_ESTADO.setPosition(visualAFND.getWidth() - 260, 200);
    BUTTON_ELIMINAR_ESTADO.setPosition(visualAFND.getWidth() - 140, 200);
    BUTTON_ADD_CONEXION_NORMAL.setPosition(visualAFND.getWidth() - 260, 290);
    BUTTON_ADD_CONEXION_BUCLE.setPosition(visualAFND.getWidth() - 140, 290);
    BUTTON_ELIMINAR_CONEXION.setPosition(visualAFND.getWidth() - 200, 350);
    BUTTON_COMPROBAR_AUTOMATA.setPosition(visualAFND.getWidth() - 80, 440);
    BUTTON_COMPROBACION_PASOS_AUTOMATA.setPosition(visualAFND.getWidth() - 200, 490);
    TEXT_FIELD.setBounds(visualAFND.getWidth() - 200, 440, 110, 40);
  ...
  private void drawLabels(Graphics2D g) {
    ...
    GraphicsUtils.drawStringOnPoint(g, "Menú", visualAFND.getWidth() - 285 / 2, 20);

    g.setColor(GRAY_TEXT_COLOR);
    GraphicsUtils.drawStringOnPoint(g, "Agregar estados", visualAFND.getWidth() - 285 / 2, 55);
    GraphicsUtils.drawStringOnPoint(g, "Agregar conexiones", visualAFND.getWidth() - 285 / 2, 267);
    GraphicsUtils.drawStringOnPoint(g, "Ejecutar autómata", visualAFND.getWidth() - 285 / 2, 415);
  }

  private void drawBackground(Graphics2D g) {
    g.setColor(ToggleButton.DEFAULT_COLOR);
    g.fillRect(visualAFND.getWidth() - MENU_WIDTH, 0, MENU_WIDTH, visualAFND.getHeight());

    g.setColor(Color.WHITE);
    g.fillRect(visualAFND.getWidth() - 285, 40, 285, visualAFND.getHeight());
  }
