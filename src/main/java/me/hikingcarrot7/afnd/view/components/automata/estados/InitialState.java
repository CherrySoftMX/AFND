...
public class InitialState extends VNode {
  ...
  private void updateTrianglePos() {
    triangle.setOrigenX(xCenter - TRIANGLE_LENGTH - VNode.NODE_RADIUS - VNode.STROKE_WIDTH);
    triangle.setOrigenY(yCenter);
    triangle.setDestinoX(xCenter);
    triangle.setDestinoY(yCenter);
    triangle.setLength(TRIANGLE_LENGTH);
    triangle.setOffset(VNode.NODE_RADIUS + VNode.STROKE_WIDTH);
  }
